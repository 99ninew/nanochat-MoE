...
from nanochat_moe.common import compute_init, compute_cleanup, get_dist_info, print0, autodetect_device_type
# Use MoE-aware checkpoint manager when running scripts_moe
...
if __name__ == "__main__":
    ...
    model_tag_str = f" {args.model_tag}" if args.model_tag else ""
    get_report().log(section="Chat evaluation " + args.source + model_tag_str, data=[
        vars(args), # CLI args
        results,
        chatcore_metric_dict,
    ])
